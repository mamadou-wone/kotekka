...
describe('Product Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Category query and add missing value', () => {
      ...
      const category: ICategory = { id: 9059 };
      product.category = category;

      const categoryCollection: ICategory[] = [{ id: 11316 }];
    ...
    it('Should call Collection query and add missing value', () => {
      const product: IProduct = { id: 456 };
      const collections: ICollection[] = [{ id: 32443 }];
      product.collections = collections;

      const collectionCollection: ICollection[] = [{ id: 14309 }];
    ...
    it('Should update editForm', () => {
      const product: IProduct = { id: 456 };
      const category: ICategory = { id: 29586 };
      product.category = category;
      const collections: ICollection = { id: 25919 };
      product.collections = [collections];
